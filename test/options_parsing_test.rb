  ...
  describe "::parse_options" do
    ...
    describe "simple cases" do
      it "returns empty hash with empty array" do
        result = Lucy.parse_options([])
        result.must_equal({})
      end

      it "understands -n" do
        result = Lucy.parse_options(%w(-n))
        result.must_equal({'n' => true})
      end

      it "understands -n is the best" do
        result = Lucy.parse_options(%w(-n is the best))
        result.must_equal({'n' => 'is the best'})
      end

      it "understands -n 1" do
        result = Lucy.parse_options(%w(-n 1))
    ...
    describe "bad input" do
      ...
      it "is ok with only leading words" do
        result = Lucy.parse_options(%w(wtf bbq))
        result.must_equal({})
      end
    end
    ...
    describe "edge cases" do
      it "lets you use lots of words" do
        result = Lucy.parse_options(%w(wtf bbq --foo bar none --foo-baz -n 1 -t))
